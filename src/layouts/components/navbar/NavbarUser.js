      ...
      {props.userData.actor === "DOCTOR" ? (
        <DropdownItem
          ...
          onClick={(e) =>
            handleNavigation(
              e,
              `/profile_settings?id=${props.userData.profile.id}`
            )
          }
        >
        ...
        onClick={(e) => {
          ...
          if (isAuthenticated) {
            ...
            if (provider !== null) {
              ...
              return props.logout(props.token, props.userData.actor);
            }
          }
        }}
      >
    ...
    return (
      <ul className="nav navbar-nav navbar-nav-user float-right">
        ...
        <NavItem className="nav-search" onClick={this.handleNavbarSearch}>
          {this.props.userData.actor === "DOCTOR" ||
          this.props.userData.actor === "STAFF" ? (
          ...
          <DropdownToggle tag="a" className="nav-link dropdown-user-link">
            ...
            <span data-tour="user">
              <Avatar
                ...
                src={this.props.userData.profile.image}
                alt=""
              />
              {/* <img
