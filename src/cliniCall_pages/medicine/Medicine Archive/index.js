...
class MedicineList extends Component {
  ...
  getArchiveMedicine = async (page) => {
    try {
      let url = "admin/deleted_medicine?page=1";
      if (page) url = `admin/deleted_medicine?page=${page}`;
      this.setState({
        isLoading: true,
      });
  ...
  handleRestore = async () => {
    try {
      this.confirmRestoreModalToggle();
      let url = "admin/restore_medicine";
      this.setState({
        isLoading: true,
      });
  ...
  handlePagination = (page) => {
    ...
    this.getArchiveMedicine(page.selected + 1);
  };
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <ModalBody>Do you really want to restore Medicine(s)?</ModalBody>
          <ModalFooter>
