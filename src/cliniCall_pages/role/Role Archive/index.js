...
class RoleList extends Component {
  ...
  getArchiveRole = async (page) => {
    try {
      let url = "admin/deleted_roles?page=1";
      if (page) url = `admin/deleted_roles?page=${page}`;
      this.setState({
        isLoading: true,
      });
  ...
  handlePagination = (page) => {
    ...
    this.getArchiveRole(page.selected + 1);
  };
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <ModalBody>Do you really want to restore Role(s)?</ModalBody>
          <ModalFooter>
