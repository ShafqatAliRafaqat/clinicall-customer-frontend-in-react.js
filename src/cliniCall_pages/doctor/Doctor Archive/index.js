...
class DoctorList extends Component {
  ...
  getArchiveDoctor = async (page) => {
    try {
      let url = "auth/deleted_doctors?page=1";
      if (page) url = `auth/deleted_doctors?page=${page}`;
      this.setState({
        isLoading: true,
      });
  ...
  handlePagination = (page) => {
    ...
    this.getArchiveDoctor(page.selected + 1);
  };
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <ModalBody>Do you really want to restore Doctor(s)?</ModalBody>
          <ModalFooter>
