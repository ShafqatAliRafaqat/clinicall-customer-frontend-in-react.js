...
import SidebarView from "./UserView";
...
class RoleList extends Component {
  ...
  getUsers = async (page) => {
    try {
      ...
      if (page) url = `admin/users?page=${page}`;
      this.setState({
        isLoading: true,
      });
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <ModalBody>Do you really want to delete User(s)?</ModalBody>
          <ModalFooter>
