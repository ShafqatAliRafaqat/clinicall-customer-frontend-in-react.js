...
class PermissionList extends Component {
  ...
  getArchivePermissions = async (page) => {
    try {
      let url = "admin/deleted_permissions?page=1";
      if (page) url = `admin/deleted_permissions?page=${page}`;
      this.setState({
        isLoading: true,
      });
  ...
  handleRestore = async () => {
    try {
      this.confirmRestoreModalToggle();
      let url = "admin/restore_permissions";
      this.setState({
        isLoading: true,
      });
  ...
  handlePagination = (page) => {
    ...
    this.getArchivePermissions(page.selected + 1);
  };
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <ModalBody>Do you really want to restore Permission(s)?</ModalBody>
          <ModalFooter>
