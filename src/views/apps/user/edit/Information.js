...
const languages = [
  { value: "english", label: "English", color: "#204593" },
  { value: "french", label: "French", color: "#204593" },
  { value: "spanish", label: "Spanish", color: "#204593" },
  { value: "russian", label: "Russian", color: "#204593" },
  { value: "italian", label: "Italian", color: "#204593" },
];

const colourStyles = {
  control: (styles) => ({ ...styles, backgroundColor: "white" }),
  option: (styles, { data, isDisabled, isFocused, isSelected }) => {
    const color = data.color ? chroma(data.color) : "#204593";
    return {
      ...styles,
      ...
      ":active": {
        ...styles[":active"],
        backgroundColor: !isDisabled && (isSelected ? data.color : "#204593"),
      },
    };
  },
  ...
  multiValueLabel: (styles, { data }) => ({
    ...styles,
    color: data.color ? data.color : "#204593",
  }),
  multiValueRemove: (styles, { data }) => ({
    ...styles,
    color: data.color,
    ":hover": {
      backgroundColor: data.color ? data.color : "#204593",
      color: "white",
    },
  }),
};
